...
public class TradeController extends BaseController {
	...
	public void textTrade(@PathVariable("tradeNo") String tradeNo)throws Exception{
		...
		//支付成功后跳转的地址
		alipayRequest.setReturnUrl( "http://127.0.0.1:8882/trade/api/updateOrderStatus/" + tradeNo);
		//该跳转地址用于检测
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = "/updateOrderStatus/{tradeNo}")
...
//	@PostMapping("/validateTradeSuccess/{tradeNo}")
//	public void validateTradeSuccess(@PathVariable("tradeNo") String tradeNo)throws Exception{
//
//		AlipayClient alipayClient =  new  DefaultAlipayClient(
//				"https://openapi.alipaydev.com/gateway.do" ,
//				"2016101800714676",
